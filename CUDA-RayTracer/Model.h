...
Triangle* loadModels(std::vector<Model*> models, std::vector<BVHPrimitiveInfo>& triangle_info, int& nmb_triangles)
{
    ...
    {      
        ...
        // hard coded materials cuz im lazy?

        if (index == 0)
            init_mesh_material << < 1, 1 >> > (d_material_ptr, make_float3(1), 0.f, 1.f, 0.f, 10.f, make_float3(1.f));
        else if (index == 1)
            init_mesh_material << < 1, 1 >> > (d_material_ptr, make_float3(1), 0.f, 1.f, 0.f, 10.f, make_float3(1.f));
        else if (index == 2)
            init_mesh_material << < 1, 1 >> > (d_material_ptr, make_float3(1), 0.f, 1.f, 0.f, 10.f, make_float3(1.f));
        else if (index == 3)
            init_mesh_material << < 1, 1 >> > (d_material_ptr, make_float3(0,1,0), 0.f, 1.f, 0.f, 10.f, make_float3(1.f));
        else if (index == 4)
            init_mesh_material << < 1, 1 >> > (d_material_ptr, make_float3(1), 0.f, 1.f, 0.f, 10.f, make_float3(1.f));
        else if (index == 5)
            init_mesh_material << < 1, 1 >> > (d_material_ptr, make_float3(1), 0.2, 1.f, 1.f, 1.f, make_float3(1.f));//make_float3(1.00, 0.86, 0.57));
        else
            init_mesh_material <<< 1, 1 >>> (d_material_ptr, make_float3(0.8,0.2,0.2), 0.2, 1.f, 1.f, 10.f, make_float3(1.f));
